...
# UNtill now I have demonstrated the principles that you need to apply - and hence you just had to apply the same approach
#as I had just showed you. Today you  get tasks that you yourself need to find out how to solve. But don't
# worry. The answers are in today's readings and/or on the internet :) 
# Also I have done it in a regular script - not markdown/notebook
